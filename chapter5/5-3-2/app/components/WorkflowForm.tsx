...
export const WorkflowForm = ({
    ...
    return (
        ...
        <form onSubmit={onSubmit} className="space-y-6">
            {/*Confuence検索クエリ欄*/}
            <div className="group">
                <label htmlFor="query" className="block text-sm font-semibold text-gray-700 mb-2 transition-colors group-hover:text-blue-600">
                    🔍 検索クエリ
                </label>
                <input
                    type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                    <label htmlFor="owner" className="block text-sm font-semibold text-gray-700 mb-2 transition-colors group-hover:text-blue-600">
                        👤 GitHub Owner
                    </label>
                    <input
                        type="text"
                ...
                {/*GitHubリポジトリ名*/}
                <div className="group">
                    <label htmlFor="repo" className="block text-sm font-semibold text-gray-700 mb-2 transition-colors group-hover:text-blue-600">
                        📁 Repository
                    </label>
                    <input
                        type="text"
