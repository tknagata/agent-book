                ...
                <div className="mb-8">
                    ...
                    <div className="grid gap-4">
                        {result.confluencePages.map((page, index) => (
                            <div key={index} className="bg-white p-5 rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200">
                ...
                <div>
                    ...
                    <div className="grid gap-4">
                        {result.githubIssues.map((issue, index) => (
                            <div key={index} className="bg-gradient-to-r from-purple-50 to-pink-50 p-5 rounded-xl border-2 border-purple-200 hover:border-purple-400 hover:shadow-md transition-all duration-200">
